...
1. Copy the project folder that best matches the new use case.
2. Rename packages, app identifiers, and repository names.
3. Install dependencies and run the local setup described in each project README.

## Notes

- Generated artifacts and local caches are intentionally excluded from this monorepo.
- Each project keeps its own internal structure so it can be extracted independently later.
