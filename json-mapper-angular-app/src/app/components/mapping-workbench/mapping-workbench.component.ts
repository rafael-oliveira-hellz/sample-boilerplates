...
import { MappingDraft, PROGRAMMING_TYPE_OPTION_GROUPS, SchemaNodeDraft, TargetBindingMode } from '@models/mapper.models';
import { rankSuggestedSources } from '@utils/mapper.utils';
...
export class MappingWorkbenchComponent {
  ...
  readonly texts = UI_TEXTS.workbench;
